...
If you have questions or feedback, please contact [rish](https://warpcast.com/rish) on Farcaster or [Slack](https://neynar.com/slack) .
...
# Create Farcaster Bots via Script Using Neynar SDK – Step-by-Step Guide
...
<Info title="Neynar-branded vs Developer-branded Signers">
  ...
  * [Neynar Managed Signers](/docs/integrate-managed-signers) when building your own custom frontend
  ...
  <Frame>
    <img src="https://mintlify.s3.us-west-1.amazonaws.com/neynar/images/docs/neynar-branded-signer-approval-screen.png" alt="Neynar branded approval screen" style={{ maxWidth: '45%', marginRight: '2%' }} />

    <img src="https://mintlify.s3.us-west-1.amazonaws.com/neynar/images/docs/developer-branded-signer-approval-screen.png" alt="Developer branded approval screen" style={{ maxWidth: '45%' }} />
  </Frame>
</Info>
...
# Enterprise Indexer Service: Stream Farcaster Data into Your PostgreSQL in Real-Time
Source: https://docs.neynar.com/docs/indexer-service-pipe-farcaster-data

Enterprise-grade Farcaster data indexing service that pipes real-time data directly into your PostgreSQL database. Get complete Farcaster protocol data, custom filtering, and seamless integration for building scalable applications with comprehensive data access and analytics.
...
# Farcaster API Quickstart with Neynar SDK
Source: https://docs.neynar.com/reference/quickstart

Comprehensive quickstart guide for building on Farcaster with Neynar API. Get your API key, learn core concepts, explore endpoints, and start developing decentralized social applications with detailed examples, SDK integration, and best practices for rapid development.
...
If you have questions or feedback, please reach out to [rish](https://warpcast.com/rish) on Farcaster or [Slack](https://neynar.com/slack) .
